...
def calc_bounds5(cnp.ndarray[label_types, ndim=5] labels, int components_num):
    """
...
def calc_bounds4(cnp.ndarray[label_types, ndim=4] labels, int components_num):
    """
...
def calc_bounds3(cnp.ndarray[label_types, ndim=3] labels, int components_num):
    """
...
def calc_bounds2(cnp.ndarray[label_types, ndim=2] labels, int components_num):
    """
